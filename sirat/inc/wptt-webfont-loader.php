...
if ( ! class_exists( 'Sirat_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Sirat_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'sirat_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function sirat_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Sirat_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'sirat_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function sirat_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Sirat_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
