...
function sirat_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting('sirat_footer_social_icons_font_size',array(
    ...
    $wp_customize->add_setting( 'sirat_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'sirat_sanitize_number_range'
	) );
	$wp_customize->add_control( 'sirat_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','sirat' ),
		'section'     => 'sirat_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_control('sirat_bradcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Bradcrumbs Alignment','sirat'),
        'section' => 'sirat_left_right',
        'choices' => array(
            'Left' => __('Left','sirat'),
            'Right' => __('Right','sirat'),
