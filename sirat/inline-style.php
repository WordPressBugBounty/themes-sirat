<?php
	...
	if($sirat_first_color != false){
		$sirat_custom_css .='.scrollup, #slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover, #comments input[type="submit"].submit,.woocommerce-cart .wc-block-grid .wc-block-grid__product-onsale	{';
	...
	$sirat_slider_layout = get_theme_mod( 'sirat_slider_arrows',true);
	...
	if($sirat_featured_img_box_shadow != false){
		$sirat_custom_css .='.box-image img,  #content-vw img{';
	...
	$sirat_singlepost_image_box_shadow = get_theme_mod('sirat_singlepost_image_box_shadow',0);
	if($sirat_singlepost_image_box_shadow != false){
		$sirat_custom_css .='.feature-box img{';
			$sirat_custom_css .='box-shadow: '.esc_attr($sirat_singlepost_image_box_shadow).'px '.esc_attr($sirat_singlepost_image_box_shadow).'px '.esc_attr($sirat_singlepost_image_box_shadow).'px #cccccc;';
		$sirat_custom_css .='}';
	}
	...
	if($sirat_resp_topbar == true && get_theme_mod( 'sirat_topbar_hide_show', true) == false){
    	$sirat_custom_css .='.top-bar{';
			$sirat_custom_css .='display:none;';
		$sirat_custom_css .='} ';
	}
	...
	if($sirat_resp_slider == true && get_theme_mod( 'sirat_slider_arrows', true) == false){
    	$sirat_custom_css .='#slider{';
			$sirat_custom_css .='display:none;';
		$sirat_custom_css .='} ';
	}
	...
	if($sirat_resp_slider_button == true && get_theme_mod( 'sirat_slider_button_hide_show', true) == false){
	...
	$sirat_bradcrumbs_alignment = get_theme_mod( 'sirat_bradcrumbs_alignment','Left');
    if($sirat_bradcrumbs_alignment == 'Left'){
    	$sirat_custom_css .='@media screen and (min-width:768px) {';
		$sirat_custom_css .='.bradcrumbs{';
			$sirat_custom_css .='text-align:start;';
		$sirat_custom_css .='}}';
	}else if($sirat_bradcrumbs_alignment == 'Center'){
		$sirat_custom_css .='@media screen and (min-width:768px) {';
		$sirat_custom_css .='.bradcrumbs{';
			$sirat_custom_css .='text-align:center;';
		$sirat_custom_css .='}}';
	}else if($sirat_bradcrumbs_alignment == 'Right'){
		$sirat_custom_css .='@media screen and (min-width:768px) {';
		$sirat_custom_css .='.bradcrumbs{';
